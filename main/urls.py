...
urlpatterns = [
    ...
    path('<int:pk>/delete/', views.transaction_delete, name='transaction_list'),
    path('create/', views.transaction_create, name='transaction_create'),
                    ...
                    #+++++++++++категория url++++++++++
urlpatterns = [
    path('guide/category', views.category_create, name='category_create'),
    ...
    path('guide/category/<int:pk>/delete/', views.category_delete, name='category_delete'),
                    ...
                    #+++++++++++Подкатегория url++++++++++
urlpatterns = [
    path('guide/subcategory', views.subcategory_create, name='subcategory_create'),
    ...
    path('guide/subcategory/<int:pk>/delete/', views.subcategory_delete, name='subcategory_delete'),
                        ...
                        #+++++++++++тип url++++++++++
urlpatterns = [
    path('guide/type', views.transtype_create, name='transtype_create'),
